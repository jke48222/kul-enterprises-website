...
import pageJson from "@/content/pages/services-index.json";
import ServicesView from "./services-view";

/**
 * SERVICES, THE SERVER HALF.
 *
 * Fetches the content and owns the page metadata; app/services/services-view.tsx draws it.
 ...
 *
 * Every word is in content/pages/services-index.json and is edited at /admin. The import
...
export default async function ServicesPage() {
  const page = await tinaPage(
    "Services page",
    () => client.queries.servicesPage({ relativePath: "services-index.json" }),
    // The shape the query would have returned, built from the file on disk.
    { servicesPage: pageJson } as never,
  );

  return <ServicesView {...page} />;
}
