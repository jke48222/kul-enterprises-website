                ...
                <div>
                  ...
                  <dd className="mt-2 text-sm text-graywarm-deep">
                    ...
                    <span className="mt-1 block">
                      Licensed &amp; Insured ·{" "}
                      <Link href="/concept/safety" className="font-semibold text-ink underline underline-offset-4 hover:text-gold-dim">
                        Safety &amp; Compliance
                      </Link>
                    </span>
                  </dd>
            ...
            <Reveal>
              <div className="rounded-2xl border border-ink/10 bg-white p-8 md:p-10">
                ...
                <p className="mb-8 mt-2 text-sm text-graywarm-deep">
                  ...
                  <Link href="/concept/quote" className="font-semibold text-ink underline underline-offset-4 hover:text-gold-dim">
                    faster lane here
                  </Link>
                  . For everything else:
                </p>
