...
/**
 * ROAD AHEAD, THE HALF THAT DRAWS.
 *
 * app/road-ahead/page.tsx fetches on the server and hands the result down. This half
 ...
 */
type Content = typeof import("@/content/pages/road-ahead.json");
...
export default function RoadAheadView(props: TinaPage<{ roadAheadPage: unknown }>) {
  ...
  const page = data.roadAheadPage as unknown as Content;
    ...
    <>
      ...
      <section className="bg-k-paper px-6 py-28 md:px-12 lg:px-24">
        <div className="mx-auto flex max-w-[1248px] flex-col gap-12">
          <Reveal variant="wipe">
            ...
            <h2
              data-tina-field={tinaField(page.plan, "heading")}
              className="max-w-[820px] font-display text-k-d2 font-black text-k-ink"
            >
      ...
      <section className="bg-k-coal px-6 py-28 md:px-12 lg:px-24">
        <div className="mx-auto flex max-w-[1248px] flex-col gap-12 lg:flex-row lg:gap-24">
          <Reveal variant="wipe" className="lg:w-[480px] lg:shrink-0">
            <h2
              data-tina-field={tinaField(page.fixed, "heading")}
      ...
      <section className="bg-k-warm px-6 py-24 md:px-12 lg:px-24">
        <Reveal className="mx-auto flex max-w-[820px] flex-col gap-5">
          <h2
              data-tina-field={tinaField(page.limits, "heading")}
