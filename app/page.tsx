...
import ScrollTruck from "@/components/v2/ScrollTruck";
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* 5b · THE RIG — scroll-driven side profile. Deliberately placed after
          PROOF rather than beside TruckChapters so the two scrub sections are
          not adjacent. Paper ground, zero-gold. */}
      <ScrollTruck />
