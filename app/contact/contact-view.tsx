...
/**
 * CONTACT, THE HALF THAT DRAWS.
 *
 * app/contact/page.tsx fetches on the server and hands the result down. This half
 ...
 */
type Content = typeof import("@/content/pages/contact.json");
...
export default function ContactView(props: TinaPage<{ contactPage: unknown }>) {
  ...
  const page = data.contactPage as unknown as Content;
    ...
    <>
      ...
      <section className="bg-k-paper px-6 pb-20 pt-36 md:px-12 lg:px-24">
        <div className="mx-auto flex max-w-[1248px] flex-col gap-7">
          ...
          <h1
              ...
              className="max-w-[820px] font-display text-k-d1 font-black text-k-ink"
            >
        ...
        <div className="mx-auto grid max-w-[1248px] grid-cols-1 gap-6 lg:grid-cols-2">
          <Reveal className="flex flex-col overflow-hidden rounded-md bg-k-surface">
            ...
            <div className="flex flex-1 flex-col gap-6 p-8">
              <h2
              data-tina-field={tinaField(page.locationCard, "heading")}
          ...
          >
            ...
            <h2
              data-tina-field={tinaField(page.dispatchCard, "heading")}
              className="max-w-[500px] font-display text-k-d2 font-black text-k-on-dark"
            >
      ...
      <section className="bg-k-surface px-6 py-28 md:px-12 lg:px-24">
        <div className="mx-auto flex max-w-[1248px] flex-col gap-12">
          <Reveal className="flex flex-col gap-4">
            <h2
              data-tina-field={tinaField(page.routes, "heading")}
      ...
      >
        <div className="mx-auto flex max-w-[1248px] flex-col gap-12">
          <Reveal variant="wipe">
            <h2
              data-tina-field={tinaField(page.map, "heading")}
              className="max-w-[700px] font-display text-k-d2 font-black text-k-ink"
            >
      ...
      <section className="bg-k-paper px-6 py-28 md:px-12 lg:px-24">
        <div className="mx-auto flex max-w-[1248px] flex-col gap-12 lg:flex-row lg:gap-24">
          <div className="flex flex-col gap-5 lg:w-[420px] lg:shrink-0">
            <h2
              data-tina-field={tinaField(page.catchAll, "heading")}
              className="font-display text-k-d3 font-black text-k-ink"
            >
