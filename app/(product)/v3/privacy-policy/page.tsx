            ...
            <>
              ...
              {process.env.NEXT_PUBLIC_GA_ID ? (
                <p>
                  ...
                  website — for example which pages are read most. This data
                  does not identify you personally to us, and we do not use it
                  for advertising. The cookies involved, and how to block
                  them, are described on the Manage Cookies page.
                </p>
              ) : null}
              <p>
                We do not require you to create an account, and we do not
                collect payment card details through this website. We do not
