...
/**
 * The half that draws. app/cookies/page.tsx fetches and hands the document down;
 ...
 */
type Content = typeof import("@/content/legal/cookies.json");

export default function ManageCookiesView(props: TinaPage<{ legal: unknown }>) {
  const { data } = useTina({
    query: props.query ?? "",
