...
/**
 * The half that draws. app/privacy-policy/page.tsx fetches and hands the document down;
 ...
 */
type Content = typeof import("@/content/legal/privacy-policy.json");

export default function PrivacyPolicyView(props: TinaPage<{ legal: unknown }>) {
  const { data } = useTina({
    query: props.query ?? "",
