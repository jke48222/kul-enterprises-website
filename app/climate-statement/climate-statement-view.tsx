...
/**
 * The half that draws. app/climate-statement/page.tsx fetches and hands the document down;
 ...
 */
type Content = typeof import("@/content/legal/climate-statement.json");

export default function ClimateStatementView(props: TinaPage<{ legal: unknown }>) {
  const { data } = useTina({
    query: props.query ?? "",
