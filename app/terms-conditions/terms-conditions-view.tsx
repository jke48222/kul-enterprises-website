...
/**
 * The half that draws. app/terms-conditions/page.tsx fetches and hands the document down;
 ...
 */
type Content = typeof import("@/content/legal/terms-conditions.json");

export default function TermsConditionsView(props: TinaPage<{ legal: unknown }>) {
  const { data } = useTina({
    query: props.query ?? "",
