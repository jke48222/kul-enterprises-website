...
/**
 * Rise / RiseGroup — v3 port (v2 §3.9). Workhorse reveal: opacity 0 /
 * y:32 → rest, 0.7s EASE.out, once. RiseGroup staggers children
 * (STAGGER.items, dropping to 0.05 beyond 5). Reduced motion: 0.3s fade.
 */
...
import { EASE, STAGGER, VIEWPORT } from "@/components/v3/motion";
...
export function Rise({
  ...
  const MTag =
    (m as unknown as Record<string, ElementType>)[as as string] ?? m.div;
