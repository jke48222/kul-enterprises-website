/**
 * Vendored from Argent (github.com/seangeng/argent) by Sean Geng, MIT.
 * Argent's dependency-free 'native' engine — taken verbatim so KUL ships
 * no extra packages; only the gold tone is used (GoldGlass).
 */
/**
